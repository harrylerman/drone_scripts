...
def getparams(argv):
    ...
    try:
        ...
        print('quickplot.py -i <inputfile> -p <parameters>')
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print('quickplot.py -i <inputfile> -p <parameters>')
            ...
            params = arg.split()
    return inputfile, params

def readlog(file, params):
    '''
